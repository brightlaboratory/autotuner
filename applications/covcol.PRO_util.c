...
int main(int argc, char** argv)
{
	...
	InitAlgorithmUtil(3, 2, N, (int)T1c1, 2, N, (int)T1c2, 2, N, (int)T1c2);
	GetNewParameterValuesUtil();

	while (ShouldPROStopUtil() == 0)
	{
		T1c1 = GetReportingPointUtil(0);
		T1c2 = GetReportingPointUtil(1);
		T1c3 = GetReportingPointUtil(2);
